...
jsonDict = {
    ...
    "CNVSomaticPanelWorkflow.gatk_docker": "broadinstitute/gatk:4.1.4.1",
    "CNVSomaticPanelWorkflow.gatk4_jar_override": "/opt/gatk-4.1.4.1/gatk-package-4.4.0.0-local.jar".format(appPath),
